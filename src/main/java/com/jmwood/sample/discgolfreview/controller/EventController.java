...
public class EventController {
    ...
    public ResponseEntity submitAuthEvent(@RequestBody AuthEvent authEvent) {
        ...
        authEventKafkaTemplate.send(authEventKafkaTemplate.getDefaultTopic(), authEvent.getUser().getId(), persistedEvent);
    ...
    public ResponseEntity submitClickEvent(@RequestBody ClickEvent clickEvent) {
        ...
        clickEventKafkaTemplate.send(clickEventKafkaTemplate.getDefaultTopic(), clickEvent.getUser().getId(), persistedEvent);
        return ResponseEntity.ok().build();
    }
