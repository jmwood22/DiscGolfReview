...
public class EventController {
    ...
    public ResponseEntity submitAuthEvent(@RequestBody AuthEvent authEvent) {
        ...
        authEventKafkaTemplate.send(authEventKafkaTemplate.getDefaultTopic(), authEvent.getSessionId(), persistedEvent);
    ...
    public ResponseEntity submitNavEvent(@RequestBody NavEvent navEvent) {
        ...
        navEventKafkaTemplate.send(navEventKafkaTemplate.getDefaultTopic(), navEvent.getSessionId(), persistedEvent);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity submitClickEvent(@RequestBody ClickEvent clickEvent) {
        ...
        clickEventKafkaTemplate.send(clickEventKafkaTemplate.getDefaultTopic(), clickEvent.getSessionId(), persistedEvent);
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity submitCourseEvent(@RequestBody CourseEvent courseEvent) {
        ...
        courseEventKafkaTemplate.send(courseEventKafkaTemplate.getDefaultTopic(), courseEvent.getSessionId(), persistedEvent);
        return ResponseEntity.ok().build();
    }
}
